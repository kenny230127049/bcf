...
$db = getDB();
$id = $_GET['id'] ?? '';
$reg = $db->fetch('SELECT wp.*, w.judul, w.biaya, w.tanggal, w.waktu, w.lokasi FROM b_workshop_pendaftar wp JOIN b_workshop w ON wp.workshop_id = w.id WHERE wp.id = ?', [$id]);
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="mt-3">
                                ...
                                <div><strong>Sekolah:</strong> <?= htmlspecialchars($reg['sekolah'] ?? '-') ?></div>
