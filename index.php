        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 d-flex align-items-center">
                    <div>
                        <p>Kreativitas adalah kemampuan melahirkan gagasan, ide, atau produk baru yang berbeda dari sebelumnya. Melalui kreativitas, kita bisa menciptakan inovasi yang sesuai perkembangan zaman. Salah satunya terlihat dari program projek kreatif kewirausahaan di SMK Budi Luhur, di mana siswa belajar merencanakan, memproduksi, hingga memasarkan karya mereka, sekaligus melatih keterampilan teknis, manajerial, dan kerja tim.</p>
                        <p>Untuk mendukung itu, SMK Budi Luhur mengadakan BLUVOCATION CREATIVE FEST dengan berbagai lomba kreatif seperti short video, infografis, robotik, dan lainnya yang terbuka untuk umum. Sorotan utama acara ini adalah film pendek orisinal karya siswa yang digarap dengan penuh semangat, menunjukkan bakat luar biasa mereka. Setiap karya yang ditampilkan adalah bibit unggul untuk perubahan, dan mari bersama memberi dukungan agar acara ini sukses serta bermanfaat bagi semua.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <video src="videos/TEASER BLUE CREATIVE FESTIVAL.mp4" style="width: 100%;" controls></video>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide p-4">
                    <img src="images/gallery/GQ1A1239.JPG" alt="" style="width: 100%">
                </li>
                <li class="splide__slide p-4">
                    <img src="images/gallery/GQ1A1340.JPG" alt="" style="width: 100%">
                </li>
                <li class="splide__slide p-4">
                    <img src="images/gallery/GQ1A1797.JPG" alt="" style="width: 100%">
                </li>
                <li class="splide__slide p-4">
                    <img src="images/gallery/GQ1A1875.JPG" alt="" style="width: 100%">
                </li>
                <li class="splide__slide p-4">
                    <img src="images/gallery/GQ1A1964.JPG" alt="" style="width: 100%">
                </li>
            </ul>
        </div>
    </section>
