...
// Ambil detail lomba
$lomba = $db->fetch("SELECT * FROM kategori_lomba WHERE id = ? AND status = 'aktif'", [$lomba_id]);
...
if ($auth->isLoggedIn()) {
    ...
    $sudahDaftar = $db->fetch(
        "SELECT * FROM user_pendaftaran WHERE user_id = ? AND kategori_lomba_id = ?",
        ...
        <div class="content-section">
            ...
            <div class="info-grid">
                <div class="info-card">
                    ...
                    <p><?php echo htmlspecialchars($lomba['periode_pendaftaran'] ?? '1 Januari - 31 Januari 2024'); ?></p>
                </div>
                <div class="info-card">
                    <i class="fas fa-users"></i>
                    <h5>Peserta</h5>
                    <p><?php echo htmlspecialchars($lomba['peserta'] ?? 'Siswa SMP Kelas VII, VIII, IX'); ?></p>
                </div>
                <div class="info-card">
