...
$timelines = $db->fetchAll(
    "SELECT * FROM b_timeline_lomba 
     ...
     ORDER BY 
       CASE 
         WHEN LOWER(judul) LIKE '%pendaftaran%' THEN 1
         WHEN LOWER(judul) LIKE '%technical meeting%' THEN 2
         WHEN LOWER(judul) LIKE '%teknikal meeting%' THEN 2
         WHEN LOWER(judul) LIKE '%tm%' THEN 2
         WHEN LOWER(judul) LIKE '%seleksi%' THEN 3
         WHEN LOWER(judul) LIKE '%penyisihan%' THEN 3
         WHEN LOWER(judul) LIKE '%pengumuman%' THEN 4
         ELSE 5
       END,
       tanggal_mulai ASC",
    [$lomba_id]
...
<body>
    ...
    <div class="container">
        ...
        <div class="rule-book-section">
            ...
            <h2 class="mb-4">RuleBook Lomba</h2>
            <p class="lead mb-4">
                Unduh rule book untuk mengetahui ketentuan dan peraturan lomba secara lengkap
            </p>

            <div class="d-flex justify-content-center flex-wrap">
                <!-- <a href="uploads/rulebook/<?php //echo $lomba['id']; 
                                                ?>.pdf" class="btn-primary-custom" target="_blank">
